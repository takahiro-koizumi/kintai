...
Write-Host ""
Write-Host "==============================================="
Write-Host " Kintai (Attendance) - Local Server" -ForegroundColor Cyan
Write-Host "==============================================="
Write-Host ""
...
if ($networkBound) {
    ...
    Write-Host "  NOTE: The QR camera needs https. Use the" -ForegroundColor Yellow
    Write-Host "        GitHub Pages URL on iPad for clock-in." -ForegroundColor Yellow
} else {
    Write-Host ""
    Write-Host "  NOTE: LAN access needs admin rights." -ForegroundColor Yellow
    Write-Host "        To allow iPad access, right-click" -ForegroundColor Yellow
    Write-Host "        start-network.bat -> Run as administrator" -ForegroundColor Yellow
}
Write-Host ""
